...
function buildMaterial(type,grade,sub,prompt,shift,h){
 ...
 if(type==="Plano de aula") return `${h}\n\nPLANO DE AULA\n\n${common}\n\nOBJETIVOS DE APRENDIZAGEM\n• Compreender os conceitos centrais de ${prompt}.\n• Relacionar o conteúdo a situações do cotidiano.\n• Desenvolver participação, argumentação e registro.\n\nDURAÇÃO SUGERIDA\n50 a 100 minutos, podendo ser adaptada ao horário da turma.\n\nACOLHIDA E CONHECIMENTOS PRÉVIOS\nInicie com perguntas disparadoras sobre ${prompt}. Registre as hipóteses dos estudantes e retome conhecimentos já trabalhados.\n\nDESENVOLVIMENTO\n1. Apresente o problema ou situação motivadora.\n2. Faça uma explicação dialogada, usando exemplos concretos.\n3. Proponha atividade individual ou colaborativa.\n4. Faça a socialização e sistematize as conclusões.\n\nATIVIDADE PRÁTICA\nCrie uma tarefa em que os estudantes precisem observar, resolver, produzir ou explicar algo relacionado a ${prompt}.\n\nAVALIAÇÃO\nObserve participação, compreensão, estratégias utilizadas, registros e capacidade de explicar o que aprendeu.\n\nADAPTAÇÕES\nOfereça instruções em etapas, exemplos visuais, tempo adicional quando necessário e diferentes formas de registro.\n\nRECURSOS\nQuadro, folhas, lápis, materiais concretos e recursos digitais disponíveis.`;
 if(type==="Prova e avaliação") return `${h}\n\nAVALIAÇÃO\n\n${common}\n\nORIENTAÇÕES\n${intro}\n\nQUESTÕES\n1. Questão objetiva sobre ${prompt}.\n2. Questão de associação ou classificação.\n3. Questão de resposta curta com justificativa.\n4. Situação-problema contextualizada.\n5. Questão de aplicação do conteúdo em uma situação cotidiana.\n\nGABARITO\n1. Resposta coerente com o conceito central trabalhado.\n2. Associação/classificação conforme o conteúdo desenvolvido.\n3. Deve apresentar ideia principal e justificativa.\n4. Valorize estratégia e raciocínio, além do resultado.\n5. Considere aplicação correta do conceito.\n\nCRITÉRIOS\nCompreensão, aplicação, clareza do registro, autonomia e participação.`;
 if(type==="Lista de exercícios") return `${h}\n\nLISTA DE EXERCÍCIOS\n\n${common}\n\n${intro}\n\n1. Retome o conceito de ${prompt} com suas próprias palavras.\n2. Resolva uma situação simples relacionada ao tema.\n3. Compare dois exemplos e explique a diferença.\n4. Resolva uma situação-problema contextualizada.\n5. Crie um exemplo próprio sobre ${prompt}.\n6. Desafio: explique como você ensinaria esse conteúdo a um colega.\n\nGABARITO ORIENTADOR\nAs respostas devem demonstrar compreensão do conceito, uso adequado da estratégia e justificativa.`;
 if(type==="Slides") return `${h}\n\nROTEIRO DE SLIDES\n\n${common}\n\nSLIDE 1 — TÍTULO\n${prompt}\n\nSLIDE 2 — OBJETIVOS\nO que vamos aprender e por que esse conhecimento é importante.\n\nSLIDE 3 — ATIVAÇÃO\nPergunta ou imagem para levantar conhecimentos prévios.\n\nSLIDE 4 — CONCEITO PRINCIPAL\nExplicação curta com exemplos.\n\nSLIDE 5 — EXEMPLO\nSituação prática relacionada ao cotidiano.\n\nSLIDE 6 — DESAFIO\nPergunta para a turma resolver em duplas ou grupos.\n\nSLIDE 7 — SISTEMATIZAÇÃO\nResumo visual dos pontos principais.\n\nSLIDE 8 — AVALIAÇÃO\nPergunta de saída para verificar a aprendizagem.`;
 if(type==="Mapa mental") return `${h}\n\nMAPA MENTAL\n\nCENTRO: ${prompt}\n\nCONCEITO PRINCIPAL\n→ definição\n→ características\n→ exemplos\n\nAPLICAÇÃO\n→ situações do cotidiano\n→ problemas que podem ser resolvidos\n\nVOCABULÁRIO\n→ palavras-chave do conteúdo\n\nSÍNTESE\n→ o que o estudante precisa lembrar ao final.`;
 if(type==="Resumo") return `${h}\n\nRESUMO DIDÁTICO\n\n${common}\n\nIDEIA CENTRAL\n${prompt} é o eixo do estudo desta proposta.\n\nPONTOS-CHAVE\n• Conceitos essenciais.\n• Características e relações.\n• Exemplos de aplicação.\n• Vocabulário importante.\n\nPARA REVISAR\nPeça ao estudante que explique o conteúdo sem consultar o material e depois compare com os pontos-chave.`;
 if(type==="Jogos educativos") return `${h}\n\nJOGO EDUCATIVO\n\n${common}\n\nNOME DO JOGO\nDesafio ${prompt}\n\nOBJETIVO\nReforçar ${prompt} de maneira lúdica e colaborativa.\n\nCOMO JOGAR\n1. Divida a turma em equipes ou duplas.\n2. Apresente desafios graduados.\n3. Dê pontos por resposta correta e por justificativa.\n4. Inclua uma rodada final de desafio.\n\nVARIAÇÕES\nUse cartas, quadro, dados, perguntas orais ou versão digital.`;
 return `${h}\n\n${type.toUpperCase()}\n\n${common}\n\nPROPOSTA\n${intro}\n\nETAPA 1 — PREPARAÇÃO\nDefina o objetivo principal e os conhecimentos prévios necessários.\n\nETAPA 2 — DESENVOLVIMENTO\nOrganize uma atividade ativa, contextualizada e adequada ao nível da turma.\n\nETAPA 3 — PRODUÇÃO\nPeça um registro, produto, apresentação ou resolução relacionada a ${prompt}.\n\nETAPA 4 — AVALIAÇÃO\nObserve evidências de aprendizagem e registre avanços e dificuldades.\n\nINCLUSÃO\nDisponibilize diferentes formas de participação e registro.`;
}
...
$$(".nav").forEach(n=>n.addEventListener("click",()=>{render(n.dataset.page);$(".sidebar").classList.remove("open");if(n.dataset.page==="calendar")setTimeout(drawEvents,0);if(n.dataset.page==="attendance")setTimeout(renderAttendance,0)}));
